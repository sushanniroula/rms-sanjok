...
<body background="Image/6.jpg">
    ...
    <div class="title">
        <a href="dashboard.php"><img src="Image/logo1.png" alt="" class="logo"></a>
    ...
    <div class="main">
        <form action="" method="post">
            ...
            <legend>Enter Marks</legend>
                ...
                <input type="text" name="p1" id="" placeholder="Math" autocomplete="off">
                <input type="text" name="p2" id="" placeholder="Physics" autocomplete="off">
                <input type="text" name="p3" id="" placeholder="Chemistry" autocomplete="off">
                <input type="text" name="p4" id="" placeholder="Computer 1" autocomplete="off">
                <input type="text" name="p5" id="" placeholder="Computer 2" autocomplete="off">
...
<div class="footer">
        <div class="footinfo">
          <center>  <p>Copyright &copy 2019 All Right Reserved. Designed by:<b><b> Sanjok Dhungana</b></p>
        </div>
    </div>
</body>
</html>
