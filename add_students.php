...
<body background="Image/img.jpg">
    ...
    <div class="main">
        <form action="" method="post">
            <fieldset>
                ...
                <input type="text" name="student_name" placeholder="Student Name" autocomplete="off">
                <input type="text" name="roll_no" placeholder="Roll No" autocomplete="off">
                <?php
                    include('init.php');
                    include('session.php');
    ...
    <div class="footer">
        <div class="footinfo">
          <center>  <p>Copyright &copy 2019 All Right Reserved. Designed by:<b> Sanjok Dhungana</b></p>
        </div>
    </div>
</body>
</html>
