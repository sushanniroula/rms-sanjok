...
<img src="Image/logo1.png" alt="" class="logo"></a>
...
<input type="text" name="p2" id="" placeholder="Chemistry" autocomplete="off">
                
<input type="text" name="p3" id="" placeholder="Physics" autocomplete="off">
